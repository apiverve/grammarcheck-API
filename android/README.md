...
```gradle
dependencies {
    implementation 'com.github.apiverve:grammarcheck-api:1.1.12'
}
```
...
```java
import com.apiverve.grammarcheck.GrammarCheckAPIClient;
import com.apiverve.grammarcheck.APIResponse;
import com.apiverve.grammarcheck.APIException;

// Initialize the client
GrammarCheckAPIClient client = new GrammarCheckAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/grammarcheck](https://docs.apiverve.com/ref/grammarcheck)
...
- **Documentation:** [https://docs.apiverve.com/ref/grammarcheck](https://docs.apiverve.com/ref/grammarcheck)
- **Issues:** [GitHub Issues](https://github.com/apiverve/grammarcheck-api/issues)
