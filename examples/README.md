# Grammar Check API - Examples

This folder contains example code for using the Grammar Check API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/grammarcheck',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/grammarcheck");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/grammarcheck](https://docs.apiverve.com/ref/grammarcheck)
